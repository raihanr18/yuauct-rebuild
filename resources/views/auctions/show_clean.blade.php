                    ...
                    <div class="auction-detail-grid">
                        <div class="space-y-3">
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold text-accent">{{ $auction->item->category }}</span>
                            </div>
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                <span class="font-semibold text-green-600">{{ $auction->formatted_starting_bid }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    @if($auction->isActive() && Auth::user()->role === 'user')
                        ...
                        <div class="p-6">
                            <form action="{{ route('auctions.bid', $auction) }}" method="POST" class="space-y-4">
                                @csrf
                                <div>
                                    <label for="bid_amount" class="flex items-center text-sm font-medium text-gray-700 mb-2">
                                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                                        </svg>
                                    ...
                                    <div class="mb-3 p-3 bg-blue-50 rounded-lg border border-blue-200">
                                        ...
                                        <p class="text-xs text-blue-500 mt-1 italic">
                                            Contoh format: 1.250.000 atau 550.000
                                        </p>
                                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="max-h-64 overflow-y-auto">
                            @foreach($userBids as $bid)
                                <div class="bid-history-item {{ $loop->first ? 'bg-green-50 border-green-200' : 'bg-gray-50' }}">
                                    <div class="flex justify-between items-center">
                                        <span class="font-semibold {{ $loop->first ? 'text-green-700' : 'text-gray-700' }}">
                                            {{ $bid->formatted_bid_amount }}
                                        </span>
                                        <span class="text-xs {{ $loop->first ? 'text-green-600' : 'text-gray-500' }}">
